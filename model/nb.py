...
# Gunakan dataset dari main.py jika sudah tersedia
try:
    X, y = main.load_data()  # Misalnya ada fungsi load_data di main.py
except AttributeError:
    print("Fungsi load_data tidak ditemukan, gunakan dataset buatan.")
